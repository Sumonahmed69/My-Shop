...
const ResultListPage = () => {
  const renderRow = (item: Result) => (
    ...
    >
      ...
      <td className="text-black">{item.student}</td>
      <td className="hidden md:table-cell text-black">{item.score}</td>
      <td className="hidden md:table-cell text-black">{item.teacher}</td>
      <td className="hidden md:table-cell text-black">{item.class}</td>
  ...
  return (
    <div className="bg-white p-4 rounded-md flex-1 m-4 mt-0">
      ...
      <div className="flex items-center justify-between">
        <h1 className="hidden md:block text-lg font-semibold text-gray-700">All Results</h1>
